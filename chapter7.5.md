...
![表56：读访问结构](./CANopen_DS301_CN_image/56.png)
<center/>表56：读访问结构
...
CANopen设备复位(对于子索引01h到7Fh执行NMT复位节点服务，对于子索引02h需要执行NMT 复位通信服务)或掉电重启后默认值生效。
